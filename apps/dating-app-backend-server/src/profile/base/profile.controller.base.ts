...
export class ProfileControllerBase {
  ...
  async BrowseProfiles(
    ...
    return this.service.BrowseProfiles(body);
  }

  @common.Post("/profile/create")
  @swagger.ApiOkResponse({
    type: ProfileOutput,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async CreateNewProfile(
    ...
    return this.service.CreateNewProfile(body);
  }

  @common.Put("/profile/update/:id")
  @swagger.ApiOkResponse({
    type: ProfileOutput,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async UpdateExistingProfile(
    ...
    return this.service.UpdateExistingProfile(body);
  }
}
