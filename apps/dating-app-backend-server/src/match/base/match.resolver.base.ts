...
export class MatchResolverBase {
  ...
  @graphql.Mutation(() => MatchOutput)
  async DislikeProfile(
    @graphql.Args()
    args: string
  ): Promise<MatchOutput> {
    return this.service.DislikeProfile(args);
  }

  @graphql.Query(() => [MatchOutput])
  async GetMatches(
    @graphql.Args()
    args: string
  ): Promise<MatchOutput[]> {
    return this.service.GetMatches(args);
  }
  ...
  async LikeProfile(
    ...
    return this.service.LikeProfile(args);
  }
}
