...
export class MatchControllerBase {
  ...
  async DislikeProfile(
    ...
    return this.service.DislikeProfile(body);
  }

  @common.Get("/match/list")
  @swagger.ApiOkResponse({
    type: MatchOutput,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async GetMatches(
    ...
    return this.service.GetMatches(body);
  }

  @common.Post("/match/like/:id")
  @swagger.ApiOkResponse({
    type: MatchOutput,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async LikeProfile(
    ...
    return this.service.LikeProfile(body);
  }
}
